        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex-shrink-0 group cursor-pointer">
            <Link href="/" className="flex items-center">
              <img src="/logo/brand-r-comm-logo-2.png" alt="Brand R.Comm Logo" className="h-10 md:h-12 lg:h-14 -my-2 md:-my-3 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
            </Link>
          </div>
