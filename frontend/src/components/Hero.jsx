...
export default function Hero() {
  ...
  return (
    <section 
      className="relative w-full min-h-[100dvh] flex flex-col items-center justify-center pt-24 md:pt-28 lg:pt-30 pb-14 overflow-hidden bg-cover bg-center"
    ...
    >
      ...
      {/* Text Container */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-10 pt-2 pb-6 md:pb-8 w-full flex flex-col items-center justify-center text-center opacity-0 animate-fade-in-up delay-100 my-auto mt-1 md:mt-2">
