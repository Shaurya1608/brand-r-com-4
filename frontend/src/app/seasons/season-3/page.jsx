...
const speakers = [
  { name: "Prof. RB Singh", role: "Former Chancellor, CAU Imphal", imgFile: "Sumit Gupta.jpg" },
...
].map(file => `/seasons/season-3/glimpse/${file}`);
...
const season3Sponsors = {
  ...
  globalPartner: [
    ...
    { name: "Global BioAg Alliance", src: "/all_brands_logos/global-bioag-alliance.png", className: "max-h-12 sm:max-h-16 md:max-h-20 max-w-[150px] sm:max-w-[200px] object-contain hover:scale-105 transition-transform duration-300" }
  ],
  mediaPartners: [
...
const SpeakerImage = ({ speaker }) => {
  ...
  const getSrc = () => {
    if (errorCount === 0) {
      return `/seasons/season-3/speakers/${speaker.name}.jpg`;
    }
    if (errorCount === 1) {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <div className="mb-3 flex justify-center">
              <img src="/seasons/season-3/logos/brand-r-comm-3-logo-02.png" onError={(e) => { e.target.src = '/logo/brand-r-comm-logo-2.png'; }} alt="Brand R.Comm" className="h-20 sm:h-26 md:h-32 lg:h-38 object-contain drop-shadow-2xl" />
            </div>
