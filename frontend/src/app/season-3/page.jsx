...
export default function Season3Page() {
  return (
    <main className="min-h-screen bg-brand-surface text-brand-dark font-sans selection:bg-brand-primary selection:text-white overflow-x-hidden">
      ...
      >
        {/* Center Radial Dark Overlay - keeps sides clear while darkening center for text */}
        <div 
          className="absolute inset-0 pointer-events-none" 
          style={{ background: 'radial-gradient(ellipse at center, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.45) 60%, rgba(0,0,0,0.15) 100%)' }}
        />
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          >
            {/* Center Dark Frosted Container for 100% Crisp Text Readability */}
            <div className="w-full max-w-4xl bg-black/60 backdrop-blur-md p-6 sm:p-8 md:p-10 rounded-3xl border border-white/10 shadow-2xl flex flex-col items-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-[#a3d95b] font-mono text-xs font-bold uppercase tracking-widest mb-6 shadow-lg backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-4xl">
              {/* Card 1: Event */}
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-5 border border-white/15 shadow-xl hover:border-[#a3d95b]/50 transition-all flex items-center gap-4 text-left">
