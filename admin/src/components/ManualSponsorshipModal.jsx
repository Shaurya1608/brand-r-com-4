                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <input
                      ...
                      className="flex-1 min-w-0 px-4 py-2.5 border border-gray-300 rounded-xl text-xs sm:text-sm font-medium text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#5e8e33]/30 focus:border-[#5e8e33] transition-all bg-gray-50/50 focus:bg-white"
                    />
                  </div>
                </div>
