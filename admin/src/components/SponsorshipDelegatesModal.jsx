...
export default function SponsorshipDelegatesModal({ isOpen, onClose, sponsorship }) {
  ...
  const fetchLinkedDelegates = async () => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/sponsorships/${sponsorship._id}/delegates`, {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-extrabold text-gray-900">
                Registered Delegates — {sponsorship.companyName}
              </h2>
              <p className="text-xs text-gray-500 font-medium">
                {sponsorship.sponsorshipCategory} ({sponsorship.sponsorshipTier || 'Sponsor'})
              </p>
            </div>
          </div>
          <button 
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar flex-1">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-xs font-semibold text-gray-500">Loading sponsor members...</p>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p className="text-sm font-bold text-gray-800">No delegates added yet for this sponsor</p>
              <p className="text-xs text-gray-500 mt-1">Click "Add Delegate" in the Sponsorships table to register free members under this sponsor.</p>
            </div>
          ) : (
